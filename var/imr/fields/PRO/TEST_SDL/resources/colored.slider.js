	...
	$("#ans").keyup(function() 
{
	...
	//alert(charsCount);
	$("#charCount").text(charsCount + " caratteri");
	$("#prog").remove();
	$("<input type='range' name='sliders' id='slider0'  value='"+charsCount+"' min='0' max='100' data-highlight='true'>").insertAfter(this);
