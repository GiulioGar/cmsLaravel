...
if (tipodomanda.indexOf("qst_scale") >= 0)
{
	...
	{ 
		...
		$( "tbody tr" ).each(function() 
		{
			...
			$("input#cell"+iter+"\\:"+selezione).attr('checked', 'checked');
			iter++;
			row++;
		}); 
	...
	{ 
		...
		$( "tbody tr" ).each(function() 
		{
			...
			for (k = 0; k < numopt; k++) 
			{
				...
				var tipo=$("input#cell"+iter+"\\:"+select).attr("type");
				...
				if ((tipo=='radio' && conta==0)||(conta>=0 && tipo!='radio'))
				{
					...
					{
						//alert("ciao");
						$("input#cell"+iter+"\\:"+select).prop("checked", true);
		...
		if (vista=="columns")
		{
			...
			$( "th.even" ).each(function() 
			{
				...
				for (k = 0; k < numopt; k++) 
				{
					...
					var tipo=$("input#cell"+select+"\\:"+iter).attr("type");
					...
					if ((tipo=='radio' && conta==0)||(conta>=0 && tipo!='radio'))
					{
						...
						{
							//alert("ciao");
							$("input#cell"+select+"\\:"+iter).prop("checked", true);
