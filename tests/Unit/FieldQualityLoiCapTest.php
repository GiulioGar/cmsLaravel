...
class FieldQualityLoiCapTest extends TestCase
{
    ...
    // Caso 2: score ordinario 20, LOI < 60s → score finale 20, cap applied ma non riduce
    // Solo LOI (peso 30, risk 80): totalRisk=80, score=20 → già ≤ 35, cap applied=true
    ...
    // Extra: score esattamente 35 con cap attivo → rimane 35
    public function testCapAppliedScoreExactlyCap(): void
    {
        // risk=65, score=35 (solo LOI peso 30): totalRisk=65, score=35
